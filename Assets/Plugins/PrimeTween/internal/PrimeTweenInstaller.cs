...
namespace PrimeTween
{
    internal class PrimeTweenInstaller : ScriptableObject
    {
        ...
        private void ResetReviewRequest() => ReviewRequest.ResetReviewRequest();
    }

    [CustomEditor(typeof(PrimeTweenInstaller), false)]
    internal class InstallerInspector : Editor
    {
        private const string pluginName = "PrimeTween";
        private const string pluginPackageId = "com.kyrylokuzyk.primetween";
        private const string tgzPath = "Assets/Plugins/" + pluginName + "/internal/" + pluginPackageId + ".tgz";
    ...
    internal static class ReviewRequest
    {
        ...
        private static void DisableReviewRequest() => EditorPrefs.SetBool(canAskKey, false);
        private static void OpenReviewsURL() => Application.OpenURL("https://assetstore.unity.com/packages/slug/252960#reviews");
