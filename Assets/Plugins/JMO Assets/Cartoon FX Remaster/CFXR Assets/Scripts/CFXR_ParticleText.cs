...
#pragma warning restore 0649
    ...
    public class ParticleTextEditor : Editor
    {
        ...
        private readonly GUIContent GUIContent_AutoUpdateToggle = new GUIContent("Auto-update", "Automatically regenerate the text when a property is changed.");
        private readonly GUIContent GUIContent_UpdateTextButton = new GUIContent(" Update Text ", "Regenerate the text and create new letter GameObjects if needed.");
