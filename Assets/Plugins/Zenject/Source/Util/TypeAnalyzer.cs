...
namespace Zenject
{
    ...
    {
        private static readonly Dictionary<Type, InjectTypeInfo> _typeInfo = new Dictionary<Type, InjectTypeInfo>();
        ...
        private static readonly Dictionary<Type, bool> _allowDuringValidation = new Dictionary<Type, bool>();
